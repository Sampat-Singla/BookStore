...
namespace Webgentle.BookStore.Controllers
{
    public class BookModelsController : Controller
    {
        ...
        public BookModelsController(BookStoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Author,Description,Category,Language,TotalPages")] BookModel bookModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Author,Description,Category,Language,TotalPages")] BookModel bookModel)
        {
            if (id != bookModel.Id)
            {
                return NotFound();
